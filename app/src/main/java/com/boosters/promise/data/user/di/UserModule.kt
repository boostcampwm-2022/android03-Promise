...
object UserModule {
    ...
    @Singleton
    @Provides
    fun provideUserRemoteDataSource(networkConnectionUtil: NetworkConnectionUtil): UserRemoteDataSource =
        UserRemoteDataSourceImpl(Firebase.firestore.collection(USERS_PATH), networkConnectionUtil)
